        ...
        <div className="dropdown">
          ...
          >
            ...
            <li>
              ...
              <ul className="p-2">
                <li>
                  <Link href="/residencial" className="text-lg">
                    Organização Residencial
                  </Link>
                </li>
                <li>
                  <Link href="/posmudanca" className="text-lg">
                    Pós Mudança
                  </Link>
                </li>
                <li>
                  <Link href="/comercial" className="text-lg">
          ...
          <li tabIndex={0}>
            <details id="details" ref={detailsRef}>
              ...
              <ul className="p-2 z-50">
                ...
                <li onClick={handleClick}>
                  <Link href="/comercial" className="text-lg whitespace-nowrap">
                    Organização Comercial
                  </Link>
                </li>
              </ul>
